@extends('partials.app')@section('meta_description',$category->meta_description)@section('seo_title',$category->seo_title)@section('meta_keywords',$category->meta_keywords)@section('content')
