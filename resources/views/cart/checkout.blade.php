@extends('partials.app')@section('seo_title','Оформление заказа')@section('meta_keywords','Оформление заказа')@section('meta_description','Оформление заказа')@section('content')
        ...
        <div class="container" data-ng-init="cc.init()">
            <div class="row">
                <div class="content col-12">
                    <form action="{{route('cart.checkout.submit')}}" method="POST">{{csrf_field()}}
                        ...
                        <div class="cart-bottom">
                            <div class="row">
                                <div class="back col-2"><a href="{{route('cart.index')}}">Вернуться</a></div>
