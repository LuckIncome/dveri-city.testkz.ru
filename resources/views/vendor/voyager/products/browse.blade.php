...
@section('page_header')
    ...
    <div class="container-fluid">
        ...
        @endcan
        <form action="{{ route('products.import') }}" id="importForm" method="POST" enctype="multipart/form-data" style="display: inline-block">
            {{csrf_field()}}
            <input
                    type="file"
                    name="file-input"
        ...
        <a href="{{ route('products.attach') }}" class="btn btn-primary btn-add-new">
