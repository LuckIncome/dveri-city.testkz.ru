...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.collapse", "ui.bootstrap.tabindex", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.common", "ui.bootstrap.dateparser", "ui.bootstrap.isClass", "ui.bootstrap.datepicker", "ui.bootstrap.position", "ui.bootstrap.datepickerPopup", "ui.bootstrap.debounce", "ui.bootstrap.multiMap", "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap", "ui.bootstrap.modal", "ui.bootstrap.paging", "ui.bootstrap.pager", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["uib/template/accordion/accordion-group.html", "uib/template/accordion/accordion.html", "uib/template/alert/alert.html", "uib/template/carousel/carousel.html", "uib/template/carousel/slide.html", "uib/template/datepicker/datepicker.html", "uib/template/datepicker/day.html", "uib/template/datepicker/month.html", "uib/template/datepicker/year.html", "uib/template/datepickerPopup/popup.html", "uib/template/modal/window.html", "uib/template/pager/pager.html", "uib/template/pagination/pagination.html", "uib/template/tooltip/tooltip-html-popup.html", "uib/template/tooltip/tooltip-popup.html", "uib/template/tooltip/tooltip-template-popup.html", "uib/template/popover/popover-html.html", "uib/template/popover/popover-template.html", "uib/template/popover/popover.html", "uib/template/progressbar/bar.html", "uib/template/progressbar/progress.html", "uib/template/progressbar/progressbar.html", "uib/template/rating/rating.html", "uib/template/tabs/tab.html", "uib/template/tabs/tabset.html", "uib/template/timepicker/timepicker.html", "uib/template/typeahead/typeahead-match.html", "uib/template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.collapse", []).directive("uibCollapse", ["$animate", "$q", "$parse", "$injector", function (a, b, c, d) {
    ...
    return {
        link: function (d, f, g) {
            function h() {
                r = !!("horizontal" in g), r ? (s = {width: ""}, t = {width: "0"}) : (s = {height: ""}, t = {height: "0"}), d.$eval(g.uibCollapse) || f.addClass("show").addClass("collapse").attr("aria-expanded", !0).attr("aria-hidden", !1).css(s)
            }
            ...
            function j() {
                f.hasClass("collapse") && f.hasClass("show") || b.resolve(n(d)).then(function () {
                    f.removeClass("collapse").addClass("collapsing").attr("aria-expanded", !0).attr("aria-hidden", !1), e ? e(f, {
                        ...
                        css: {overflow: "hidden"},
                        to: i(f[0])
                    }).start()["finally"](k) : a.addClass(f, "show", {css: {overflow: "hidden"}, to: i(f[0])}).then(k)
                }, angular.noop)
            }
            ...
            function l() {
                return f.hasClass("collapse") || f.hasClass("show") ? void b.resolve(p(d)).then(function () {
                    f.css(i(f[0])).removeClass("collapse").addClass("collapsing").attr("aria-expanded", !1).attr("aria-hidden", !0), e ? e(f, {
                        removeClass: "show",
                        to: t
                    }).start()["finally"](m) : a.removeClass(f, "show", {to: t}).then(m)
                }, angular.noop) : m()
            }
    ...
    return {
        ...
        }, scope: {heading: "@", cardClass: "@?", isOpen: "=?", isDisabled: "=?"}, controller: function () {
    ...
    var c = "uib-slideDirection", d = "carousel-item-";
    return {
        beforeAddClass: function (e, f, g) {
            if ("active" === f) {
                var h = !1, i = e.data(c), j = "next" === i ? d + "left" : d + "right",
                    k = b.bind(this, e, [j, d + i].join(" "), g);
                return e.addClass(d + i), a(e, {addClass: j}).start().done(k), function () {
                    h = !0
                }
            }
            g()
            ...
            if ("active" === f) {
                var h = !1, i = e.data(c), j = "next" === i ? d + "left" : d + "right", k = b.bind(this, e, j, g);
                return a(e, {addClass: j}).start().done(k), function () {
                    h = !0
                }
            }
            g()
    ...
    return {
        getRawNode: function (a) {
            ...
            c = this.getRawNode(c);
            var e = c.getBoundingClientRect(), f = {
                width: Math.round(angular.isNumber(e.width) ? e.width : c.offsetWidth),
                height: Math.round(angular.isNumber(e.height) ? e.height : c.offsetHeight),
            ...
            if (d) {
                var g = window.getComputedStyle(c), h = this.parseStyle(g.marginTop) + this.parseStyle(g.marginBottom),
            ...
            if (g) {
                var j = window.getComputedStyle(c), k = this.parseStyle(j.marginTop) + this.parseStyle(j.marginBottom),
                    l = this.parseStyle(j.marginLeft) + this.parseStyle(j.marginRight);
                i += k, h += l
            }
            d = this.parsePlacement(d);
            var m = e ? this.offset(a) : this.position(a), n = {top: 0, left: 0, placement: ""};
            if (d[2]) {
                var o = this.viewportOffset(a, e), p = b.getComputedStyle(c), q = {
                ...
                if (d[0] = "top" === d[0] && q.height > o.top && q.height <= o.bottom ? "bottom" : "bottom" === d[0] && q.height > o.bottom && q.height <= o.top ? "top" : "left" === d[0] && q.width > o.left && q.width <= o.right ? "right" : "right" === d[0] && q.width > o.right && q.width <= o.left ? "left" : d[0], d[1] = "top" === d[1] && q.height - m.height > o.bottom && q.height - m.height <= o.top ? "bottom" : "bottom" === d[1] && q.height - m.height > o.top && q.height - m.height <= o.bottom ? "top" : "left" === d[1] && q.width - m.width > o.right && q.width - m.width <= o.left ? "right" : "right" === d[1] && q.width - m.width > o.left && q.width - m.width <= o.right ? "left" : d[1], "center" === d[1]) if (f.vertical.test(d[0])) {
                    var r = m.width / 2 - h / 2;
            ...
            if (a.indexOf("top") !== -1 && c !== d) return {top: b.top - d + "px"}
        }, positionArrow: function (a, c) {
            a = this.getRawNode(a);
            var d = !0, e = a.querySelector(".tooltip-inner");
            if (!e) {
            ...
            if (g) {
                ...
                if (c = this.parsePlacement(c), "center" === c[1]) {
                    ...
                    if (f.vertical.test(c[0])) {
                        var j = i.width / 2, k = this.offset(a).width / 2, l = k - j;
                        h.left = "" + l + "px"
                    } else {
                        var m = i.height / 2, n = this.offset(a).height / 2, o = n - m;
                        h.top = "" + o + "px"
                    }
                }
                var p = "border-" + c[0] + "-width", q = (b.getComputedStyle(g)[p], "border-");
    ...
    b.addClass("dropdown"), this.init = function () {
        ...
        var F = u ? u : angular.element(b[0].querySelector("[uib-dropdown-menu]")), G = u ? q : r, H = F.hasClass(G),
            I = f.isOnlyOpen(a, u);
        if (H === !e) {
            var J;
    ...
    return e.$watch(l, function (a) {
        ...
        o >= 0 && !t && (u = e.$new(!0), u.modalOptions = f, u.index = o, t = angular.element('<div uib-modal-backdrop="modal-backdrop"></div>'), t.attr({
            ...
            "modal-in-class": "show"
        }), f.backdropClass && t.addClass(f.backdropClass), f.animation && t.attr("modal-animation", "true"), a.enter(d(t)(u), m), v = i.scrollbarPadding(m), v.heightOverflow && v.scrollbarWidth && m.css({paddingRight: v.right + "px"}));
        var p;
                ...
                compile: function (a, b) {
                    ...
                    return function (a, b, d, f) {
                        ...
                        var E, F, G, H, I, J, K, L, M = !!angular.isDefined(n.appendToBody) && n.appendToBody,
                            ...
                            S = !!n.useContentExp && l(d[e]), T = [], U = function () {
                                E && E.html() && (J || (J = g(function () {
                                    var a = i.parsePlacement(P.placement), c = "center" === a[1] ? a[0] : a[0] + "-" + a[1];
                                    ...
                                    E.css({top: d.top + "px", left: d.left + "px"}), K = g(function () {
    ...
    return a("uibPopoverTemplate", "popover", "click", {placementClassPrefix: "bs-popover-", useContentExp: !0})
    ...
    return a("uibPopoverHtml", "popover", "click", {placementClassPrefix: "bs-popover-", useContentExp: !0})
    ...
    return a("uibPopover", "popover", "click", {placementClassPrefix: "bs-popover-"})
...
const $dropdown = $(".dropdown"), $dropdownToggle = $(".dropdownToggle"), $dropdownMenu = $(".dropdown-menu"),
    showClass = "show";
...
LoadEvent(function () {
    ...
    $("a.fb").fancybox({
        ...
        var t = $('input[type="tel"]')[e];
        $(t).mask("+7 (999) 999-99-99")
    });
    var e = $(".home-slider .sliderArrows").find("span"), t = $(".home-slider .sliderContent");
    $(t).on("init reInit afterChange", function (t, n, o, i) {
        var s = (o || 0) + 1;
        e.text(s + "/" + n.slideCount)
    }), $(t).slick({
        infinite: !1,
        dots: !1,
        autoplay: !1,
        prevArrow: $(".home-slider .sliderArrows .prevSlide"),
        nextArrow: $(".home-slider .sliderArrows .nextSlide")
    });
    for (var n = ["new", "hit", "action"], o = 0; o < n.length; o++) {
        var i = $("#nav-" + n[o]), s = $(i).find(".tab-slider .content"), a = $(i).find(".sliderArrows");
        $(s).on("init reInit afterChange", function (e, t, n, o) {
            var i = $(window).width(), s = (n || 0) + (i > 1024 ? 4 : i <= 1024 && i >= 480 ? 2 : 1);
            $(this).parent().find(".sliderArrows span").text(s + "/" + t.slideCount)
            ...
            autoplay: !1,
            slidesToShow: 4,
            prevArrow: $(a).find(".prevSlide"),
            nextArrow: $(a).find(".nextSlide"),
    ...
    setTimeout(function () {
        var e = $(".about-page .sliderArrows").find("p"),
            t = $(".about-page .about-content").find(".slider .sliderContent");
        $(t).on("init reInit afterChange", function (t, n, o, i) {
            var s = (o || 0) + 1;
            e.text(s + "/" + n.slideCount)
        }), $(t).slick({
            ...
            autoplay: !1,
            slidesToShow: 1,
            prevArrow: $(".about-page  .about-content .sliderArrows .prevSlide"),
            nextArrow: $(".about-page  .about-content .sliderArrows .nextSlide")
        });

        $('.partners-page .nav-link').on('shown.bs.tab', function () {
            // ... select the corresponding tab pane ...
            var $tabPane = $($(this).attr('href'));
            $($tabPane).find('.sliderContent').on("init reInit afterChange", function (t, n, o, i) {
                var s = (o || 0) + 1;
                $($tabPane).find('.sliderArrows p').text(s + "/" + n.slideCount)
            });
            // ... and refresh its slider.
            $($tabPane).find('.sliderContent').slick('refresh');
        });
        var sliders = $('.partners-page').find('.slider');
        if (sliders.length) {

            for (var j = 0; j < sliders.length; j++) {
                $(sliders[j]).find('.sliderContent').on("init reInit afterChange", function (t, n, o, i) {
                    var s = (o || 0) + 1;
                    $('.partners-page .tab-pane.active.show').find('.slider').find('.sliderArrows p').text(s + "/" + n.slideCount)
                });
                if ($(sliders[j]).find('.sliderContent')) {
                    $(sliders[j]).find('.sliderContent').slick({
                        infinite: !1,
                        dots: !1,
                        autoplay: !1,
                        slidesToShow: 1,
                        prevArrow: $(sliders[j]).find(".sliderArrows .prevSlide"),
                        nextArrow: $(sliders[j]).find(".sliderArrows .nextSlide")
                    });
                }
            }
        }

    }, 200), $("select").niceSelect(), $(".compare-content").find(".products").overlayScrollbars({
        ...
        thumbMargin: 15,
        slideMargin: 5,
        responsive: [{breakpoint: 1200, settings: {vertical: !1, item: 1, thumbItem: 3, thumbMargin: 25}}]
    }), $(document).mouseup(function (e) {
        var t = $(".mini-cart"), n = $("#searchHeader"), o = $("#searchHeaderMobile");
        t.is(e.target) || 0 !== t.has(e.target).length ? t.addClass("open") : t.removeClass("open"), n.is(e.target) || 0 !== n.has(e.target).length || n.find(".items").removeClass("open"), o.is(e.target) || 0 !== o.has(e.target).length || o.find(".items").removeClass("open")
    }), $(".cart-header .cart").attr("href"), $(window).width() > 1024 ? $(".cart-header .cart").click(function () {
        $(this).parent().find(".mini-cart").addClass("open")
    }) : ($(".cart-header .cart").attr("href", "/cart"), $(".attribute.select ul.variants").each(function () {
        var e = $(this), t = $(document.createElement("select")).insertBefore($(this).hide());
        $(">li a", this).each(function () {
            var e = $(this).attr("target"),
                n = $(document.createElement("option")).appendTo(t).val(this.href).html($(this).html()).on("click", function () {
                    "_blank" === e ? window.open($(this).val()) : window.location.href = $(this).val()
                });
            "active" === $(this).parent().attr("class") && n.attr("selected", "selected")
        }), t.change(function () {
            window.location = $(this).find("option:selected").val()
        }), e.remove(), $("select").niceSelect()
    }));
    var r = $(".product-page").find(".color.attribute");
    $(r).find("li").each(function () {
        "dark" == lightOrDark($(this).data("color")) ? $(this).addClass("dark") : $(this).addClass("light")
    });
    var l = $(".related-products .sliderArrows").find("span"), d = $(".related-products .content");
    $(d).on("init reInit afterChange", function (e, t, n, o) {
        var i = $(window).width(), s = (n || 0) + (i > 1024 ? 4 : i <= 1024 && i >= 480 ? 2 : 1);
        l.text(s + "/" + t.slideCount)
    }), $(d).slick({
        infinite: !1,
        dots: !1,
        autoplay: !1,
        slidesToShow: 4,
        prevArrow: $(".related-products").find(".sliderArrows .prevSlide"),
        nextArrow: $(".related-products").find(".sliderArrows .nextSlide"),
        responsive: [{breakpoint: 1024, settings: {slidesToShow: 2, slidesToScroll: 2}}, {
            breakpoint: 768,
            settings: {slidesToShow: 2, slidesToScroll: 2}
        }, {breakpoint: 480, settings: {slidesToShow: 1, slidesToScroll: 1}}]
    }), $(window).width();
    const c = $(".callback-btn"), u = $(".popup"), p = $(".popup.popup-order-call"), h = $(".close-popup");
    $(h).on("click", function () {
        $(u).removeClass("opened"), $("body").css("overflow-y", "auto")
    }), $(c).on("click", function (e) {
        e.preventDefault(), $(p).addClass("opened"), $("body").css("overflow-y", "hidden"), $(".modal-select").niceSelect("destroy"), setTimeout(function () {
            $(".modal-select").niceSelect()
        }, 200)
    });
    var f = document.getElementById("modalFilter"), m = document.getElementsByClassName("filter-btn")[0],
        w = document.getElementsByClassName("close-filter")[0];
    document.getElementsByClassName("filter-btn").length && (m.onclick = function () {
    ...
    var g = document.getElementById("modalVideo"), v = document.getElementsByClassName("play")[0];
    document.getElementsByClassName("play").length && (v.onclick = function () {
        g.style.display = "block"
    }, window.onclick = function (e) {
        e.target == g && (g.style.display = "none", $("#modalVideo").find("iframe").each(function () {
            this.contentWindow.postMessage('{"event":"command","func":"stopVideo","args":""}', "*")
        }))
    }), $("button[type=submit]").on("click", function (e) {
        $(this).closest("form").find("input").each(function () {
            $(this).prop("required") && ($(this).val() || $(this).addClass("warning"))
        })
    }), $("form").find("input").each(function () {
        $(this).prop("required") && ($(this).blur(function () {
            $(this).val() ? $(this).removeClass("warning") : $(this).addClass("warning")
        }), $(this).keypress(function () {
            $(this).val() ? $(this).removeClass("warning") : $(this).addClass("warning")
        }))
    }), $("a.question").on("click", function () {
        $(this).parent(), $(this).find(".fa").hasClass("rotate") ? $(this).find(".fa").removeClass("rotate") : $(this).find(".fa").addClass("rotate")
    })
}), $(window).on("load resize", function () {
    this.matchMedia("(min-width: 768px)").matches ? $dropdown.hover(function () {
        const e = $(this);
        e.addClass("show"), e.find($dropdownToggle).attr("aria-expanded", "true"), e.find($dropdownMenu).addClass("show"), e.find($dropdownToggle).addClass("active")
    }, function () {
        const e = $(this);
        e.removeClass("show"), e.find($dropdownToggle).attr("aria-expanded", "false"), e.find($dropdownMenu).removeClass("show"), e.find($dropdownToggle).removeClass("active")
    }) : $dropdown.off("mouseenter mouseleave")
}), function (e) {
    e(".popup.popup-order-call form").submit(function (t) {
        e.ajax({
            url: "/popup-callback",
            dataType: "text",
            type: "post",
            ...
            success: function (t, n, o) {
                e(".popup.popup-order-call").removeClass("opened"), e(".popup.popup-thank-you").addClass("opened"), e("body").css("overflow-y", "hidden"), setTimeout(function () {
...
}(jQuery), mft = setTimeout("myFunction()", 0), LoadEvent(function () {
    myFunction()
});
