                                            ...
                                            <td>
                                                ...
                                                <?php elseif($row->type == 'text'): ?>
                                                    ...
                                                    <?php elseif($row->field == 'payment_type'): ?>
                                                        <div class="readmore"><?php echo e(($data->{$row->field} == 'cash') ? 'Наличными' : ($data->{$row->field} == 'online' ? 'Онлайн оплата(оплачен)' : 'Платежной картой')); ?></div>
                                                    <?php else: ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/b/buldoorskz/domains/dveri-city.kz/resources/views/vendor/voyager/orders/browse.blade.php ENDPATH**/ ?>